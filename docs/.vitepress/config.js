  ...
  themeConfig: {
    ...
    sidebar: {
      '/1-100期/': [
        ...
        {
          text: '11 ~ 20 期 (20190816-20190917)',
          collapsible: true,
          collapsed: true,
          items: [
        ...
        {
          text: '21 ~ 30 期 (20190920-20191018)',
          collapsible: true,
          collapsed: true,
          items: [
        ...
        {
          text: '31 ~ 40 期 (20191020-20191110)',
          collapsible: true,
          collapsed: true,
          items: [
        ...
        {
          text: '41 ~ 50 期 (20191112-20191203)',
          collapsible: true,
          collapsed: true,
          items: [
        ...
        {
          text: '51 ~ 60 期 (20191206-20200101)',
          collapsible: true,
          collapsed: true,
          items: [
        ...
        {
          text: '61 ~ 70 期 (20200103-20200124)',
          collapsible: true,
          collapsed: true,
          items: [
        ...
        {
          text: '71 ~ 80 期 (20200131-20200223)',
          collapsible: true,
          collapsed: true,
          items: [
        ...
        {
          text: '81 ~ 90 期 (20200225-20200317)',
          collapsible: true,
          collapsed: true,
          items: [
        ...
        {
          text: '91 ~ 100 期 (20200320-20200410)',
          collapsible: true,
          collapsed: true,
          items: [
      ...
      '/101-200期/': [
        {
          text: '101 ~ 110 期 (20200412-20200503)',
          collapsible: true,
          collapsed: true,
          items: [
            { text: '【睡前消息101】又是凉山火灾，又是19人牺牲，我们该吸取什么教训？', link: '/101-200期/101' },
            { text: '【睡前消息102】内蒙古地界上，还有块黑龙江的“飞地”？', link: '/101-200期/102' },
            { text: '【睡前消息103】“剑桥论文证明新冠病毒起源美国”这种说法是怎么来的？', link: '/101-200期/103' },
            { text: '【睡前消息104】别放过鲍毓明，更别忘了还会有更多“鲍毓明”', link: '/101-200期/104' },
            { text: '【睡前消息105】帮美国企业免费搬出中国？是谁说话这么幽默？', link: '/101-200期/105' },
            { text: '【睡前消息106】文在寅大胜，韩国财阀终于“敢”离婚了', link: '/101-200期/106' },
            { text: '【睡前消息107】要求学生行作揖礼，衢州想要争“儒家圣地”？', link: '/101-200期/107' },
            { text: '【睡前消息108】战斗民族：隔离？那不就等于放假了吗，度假去！', link: '/101-200期/108' },
            { text: '【睡前消息109】在该不该禁止养狗的问题背后，永远是谁出钱的问题', link: '/101-200期/109' },
            { text: '【睡前消息110】孟加拉：跨恒河不方便 中国：桥已经给你造好了', link: '/101-200期/110' },
          ]
        },
        {
          text: '111 ~ 120 期 (20200505-20200526)',
          collapsible: true,
          collapsed: true,
          items: [
            { text: '【睡前消息111】深圳房价这样涨下去，会变成第二个香港么？', link: '/101-200期/111' },
            { text: '【睡前消息112】阅文风波的背后，腾讯真的大到只手遮天了吗？', link: '/101-200期/112' },
            { text: '【睡前消息113】制造业回到美国× 能源巨头直接去中国√', link: '/101-200期/113' },
            { text: '【睡前消息114】中国媒体的战斗力，能有超越BBC那一天吗？', link: '/101-200期/114' },
            { text: '【睡前消息115】印度首富身价压倒马云，什么叫垄断资本啊？', link: '/101-200期/115' },
            { text: '【睡前消息116】美国政府罚了脸书50亿美元，这个我们真可以学？', link: '/101-200期/116' },
            { text: '【睡前消息117】不是TVB衰落了，而是香港文化回到了它的合理地位', link: '/101-200期/117' },
            { text: '【睡前消息118】《后浪》过后，如何看待B站又要《入海》？', link: '/101-200期/118' },
            { text: '【睡前消息119】王石用别人的钱，给清华捐了53亿？', link: '/101-200期/119' },
            { text: '【睡前消息120】美国女足要求和男足同工同酬，为什么被驳回？', link: '/101-200期/120' },
          ]
        },
      ],
    }
